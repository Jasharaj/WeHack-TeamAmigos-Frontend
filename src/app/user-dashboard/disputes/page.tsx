  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-black">My Legal Disputes</h1>
          <p className="text-black mt-1">Track your ongoing legal cases</p>
        </div>
        <button
      ...
      {showNewDisputeModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-2xl w-full">
            <h2 className="text-xl font-bold text-black mb-4">File New Dispute</h2>
            <form onSubmit={handleAddDispute} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">All new disputes start in pending status</p>
                </div>
              </div>
