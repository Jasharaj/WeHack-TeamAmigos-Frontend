        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600">Get instant answers to your legal questions</p>
            </div>
          </div>
            ...
            {messages.length === 0 ? (
              ...
              >
                ...
                <p className="text-slate-600 mb-8 max-w-md mx-auto">
                  Ask me anything about Indian law, legal procedures, or get advice on your legal concerns.
                </p>
                ...
                <div className="max-w-2xl mx-auto">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm font-medium text-slate-700">Try asking:</span>
                  </div>
