        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <div className="flex items-center justify-center w-20 h-20 rounded-full bg-green-100 text-green-600 text-3xl mb-6 mx-auto">
                👨‍👩‍👧‍👦
              </div>
              <h3 className="text-2xl font-semibold text-center mb-6 text-black">For Citizens</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-2xl font-semibold text-center mb-6 text-black">For Lawyers</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-green-100 flex items-center justify-center mr-3 mt-1">
                    <span className="text-green-500 text-sm">✓</span>
